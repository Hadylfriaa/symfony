 ...
 */
final class Version20231027202858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, ref VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, publication_date DATE NOT NULL, category VARCHAR(255) NOT NULL, published VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
